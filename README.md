...
6. Найдите первый запрос к странице, он будет назван как HTTP и изучите следующие аспекты:
   ...
   ![img_1.png](img_1.png) Они содержат служебную информацию,такую как User-Agent(прикидываемся браузером(юзером)),Куки,Referer(откуда мы пришли по этому url),
...
[GitHub](https://github.com)![img_7.png](img_7.png)
